...
public static class God
{
   ...
   public static List<ActionSlot> ActSlots = new List<ActionSlot>() { ActionSlot.BasicAttack ,ActionSlot.Secondary,ActionSlot.Utility,ActionSlot.Ultimate,ActionSlot.Sprint};
   ...
   public static Number N(ActorThing who,IntStats s, int m = 1,IntStats salt=IntStats.None) { return new Number(who, s,m,salt); }
   public static Number N(IntStats s, int m = 1,IntStats salt=IntStats.None) { return new Number(s,m,salt); }
